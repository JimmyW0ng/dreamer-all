...
import com.dreamer.admin.repository.SysMenuRepository;
...
import static com.dreamer.admin.domain.tables.SysMenu.SYS_MENU;
...
public class SysMenuService {
     ...
     * @return
     */
    public List<RoleMenuDto> getUserAllMenu(Long userId) {
        List<RoleMenuDto> userMenus = Lists.newArrayList();
