...
public class SysDict extends TableImpl<SysDictRecord> {
    ...
    private static final long serialVersionUID = -149060979;

    /**
     * The reference instance of <code>jw.sys_dict</code>
     */
    ...
    /**
     * The column <code>jw.sys_dict.group_name</code>. 组名
     */
    ...
    /**
     * The column <code>jw.sys_dict.key</code>. key
     */
    ...
    /**
     * The column <code>jw.sys_dict.value</code>. 数据值
     */
    ...
    /**
     * The column <code>jw.sys_dict.description</code>. 描述
     */
    ...
    /**
     * The column <code>jw.sys_dict.sort</code>. ??????
     */
    ...
    /**
     * The column <code>jw.sys_dict.status</code>.
     */
    public final TableField<SysDictRecord, SysDictStatus> STATUS = createField("status", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.dreamer.domain.enums.SysDictStatus.class), this, "");

    /**
     * The column <code>jw.sys_dict.create_at</code>. 创建时间
     */
    ...
    /**
     * The column <code>jw.sys_dict.update_at</code>. 更新时间
     */
    ...
    /**
     * The column <code>jw.sys_dict.remarks</code>. 备注
     */
    ...
    /**
     * The column <code>jw.sys_dict.del_flag</code>. 删除标记
     */
    ...
    /**
     * The column <code>jw.sys_dict.version</code>.
     */
    ...
    /**
     * Create a <code>jw.sys_dict</code> table reference
     */
    public SysDict() {
        this("sys_dict", null);
    }
    ...
    /**
     * Create an aliased <code>jw.sys_dict</code> table reference
     */
    ...
    public List<UniqueKey<SysDictRecord>> getKeys() {
        return Arrays.<UniqueKey<SysDictRecord>>asList(Keys.KEY_SYS_DICT_PRIMARY, Keys.KEY_SYS_DICT_UNIQUE_GROUP_NAME_AND_KEY);
    }
